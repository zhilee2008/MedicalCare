...
public class CRA_PatientCurrentChecked2Complete extends Fragment {
...
//    String userType;
	...
	public CRA_PatientCurrentChecked2Complete(String checkupId,String patientId) {
...
//    				crc_ordercomment
      	  ...
      	  CRA_PatientCurrentChecked2Complete.this.myHandler.sendMessage(msg);
        }
    }
