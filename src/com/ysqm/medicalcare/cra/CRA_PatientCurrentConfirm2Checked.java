...
public class CRA_PatientCurrentConfirm2Checked extends Fragment {
...
//    String userType;
	...
	public CRA_PatientCurrentConfirm2Checked(String checkupId,String patientId) {
...
//    				crc_ordercomment
      	  ...
      	  CRA_PatientCurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
