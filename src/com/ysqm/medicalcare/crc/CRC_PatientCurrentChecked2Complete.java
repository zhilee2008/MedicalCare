...
public class CRC_PatientCurrentChecked2Complete extends Fragment {
...
//    String userType;
	...
	public CRC_PatientCurrentChecked2Complete(String checkupId,String patientId) {
                ...
                new AlertDialog.Builder(CRC_PatientCurrentChecked2Complete.this.getActivity()).setTitle("提示")//设置对话框标题
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {//添加确定按钮
                            ...
                            public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                                // TODO Auto-generated method stub
                                Toast.makeText(CRC_PatientCurrentChecked2Complete.this.getActivity(), "确认成功", 5).show();
...
//                         		mapParam.put("password", "passw0rd");
                                mapParam.put("checkupId", CRC_PatientCurrentChecked2Complete.this.checkupId);
...
//    				crc_ordercomment
      	  ...
      	  CRC_PatientCurrentChecked2Complete.this.myHandler.sendMessage(msg);
        }
    }
