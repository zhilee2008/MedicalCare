...
public class CRC_CurrentConfirm2Checked extends Fragment {
...
//    String userType;
	...
	public CRC_CurrentConfirm2Checked(String checkupId) {
...
//                         		mapParam.put("password", "passw0rd");
                                mapParam.put("checkupId", CRC_CurrentConfirm2Checked.this.checkupId);
...
//    				crc_ordercomment
      	  ...
      	  CRC_CurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
