...
public class CRC_HistoryComplete extends Fragment {
...
//    String userType;
	...
	public CRC_HistoryComplete(String checkupId) {
		// TODO Auto-generated constructor stub
		this.checkupId=checkupId;
	}
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		pd = ProgressDialog.show(CRC_HistoryComplete.this.getActivity(), "提示", "加载中，请稍后……"); 
...
//    				crc_ordercomment
      	  ...
      	  CRC_HistoryComplete.this.myHandler.sendMessage(msg);
        }
    }
