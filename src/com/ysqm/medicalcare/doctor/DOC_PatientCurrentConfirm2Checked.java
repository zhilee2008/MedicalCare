...
public class DOC_PatientCurrentConfirm2Checked extends Fragment {
...
//    String userType;
	...
	public DOC_PatientCurrentConfirm2Checked(String checkupId,String patientId) {
...
//    				crc_ordercomment
      	  ...
      	  DOC_PatientCurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
