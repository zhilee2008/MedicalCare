...
public class DOC_HistoryComplete extends Fragment {
...
//    String userType;
	...
	public DOC_HistoryComplete(String checkupId) {
		// TODO Auto-generated constructor stub
		this.checkupId=checkupId;
	}
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		pd = ProgressDialog.show(DOC_HistoryComplete.this.getActivity(), "提示", "加载中，请稍后……"); 
...
//		userType = sp.getString("userType","");
		...
		cth.start();
		view= inflater.inflate(R.layout.crc_activity_history_complete, container, false);
...
//    				crc_ordercomment
      	  ...
      	  DOC_HistoryComplete.this.myHandler.sendMessage(msg);
        }
    }
