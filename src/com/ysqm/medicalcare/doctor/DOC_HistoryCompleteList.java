...
public class DOC_HistoryCompleteList extends Fragment {
	OrderedThread odth;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		pd = ProgressDialog.show(DOC_HistoryCompleteList.this.getActivity(), "提示", "加载中，请稍后……"); 
...
//						data.get(position).get("info");
						...
						FragmentActivity0.changeFragment(new DOC_HistoryComplete(checkupId));
					}
				});
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread{
        public void run() {
      	  ...
      	  DOC_HistoryCompleteList.this.myHandler.sendMessage(msg);
        }
    }
