...
public class DOC_CurrentConfirm2Checked extends Fragment {
...
//    String userType;
	...
	public DOC_CurrentConfirm2Checked(String checkupId) {
...
//    				crc_ordercomment
      	  ...
      	  DOC_CurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
