...
public class CRALEAD_ReportProjectMenuAll extends Fragment {
	String projectId;
	public CRALEAD_ReportProjectMenuAll(String projectId){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prv.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				FragmentActivity3.changeFragment(new CRALEAD_ReportProjectALl1(projectId));
			}
		});
        ...
        cv.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				FragmentActivity3.changeFragment(new CRALEAD_ReportProjectALl2(projectId));
			}
		});
        ...
        tv.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				FragmentActivity3.changeFragment(new CRALEAD_ReportProjectALl3(projectId));
			}
		});
        return v;
	}
