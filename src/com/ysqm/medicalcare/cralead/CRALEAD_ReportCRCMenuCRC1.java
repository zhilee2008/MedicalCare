...
public class CRALEAD_ReportCRCMenuCRC1 extends Fragment {
	String crcId;
	public CRALEAD_ReportCRCMenuCRC1(String crcId){
		this.crcId=crcId;
	}
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRA_REPORTCRCMENUCRC1+"?crcId="+crcId+"&token="+token);
