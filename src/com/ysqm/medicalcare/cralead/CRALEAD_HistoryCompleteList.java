...
public class CRALEAD_HistoryCompleteList extends Fragment {
	OrderedThread odth;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.cra_activity_history_complete_list, container, false);
		...
		pd = ProgressDialog.show(CRALEAD_HistoryCompleteList.this.getActivity(), "提示", "加载中，请稍后……"); 
...
//						data.get(position).get("info");
						...
						FragmentActivity0.changeFragment(new CRALEAD_HistoryComplete(checkupId));
					}
				});
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread{
        public void run() {
      	  ...
      	  CRALEAD_HistoryCompleteList.this.myHandler.sendMessage(msg);
        }
    }
