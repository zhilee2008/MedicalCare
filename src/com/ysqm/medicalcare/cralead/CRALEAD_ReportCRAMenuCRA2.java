...
public class CRALEAD_ReportCRAMenuCRA2 extends Fragment {
	String crcId;
	public CRALEAD_ReportCRAMenuCRA2(String crcId){
		this.crcId=crcId;
	}
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRALEAD_REPORTCRAMENUCRA2+"?craId="+crcId+"&token="+token);
