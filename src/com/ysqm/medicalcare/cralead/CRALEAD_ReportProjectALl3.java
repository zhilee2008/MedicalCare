...
public class CRALEAD_ReportProjectALl3 extends Fragment {
	String projectId;
	public CRALEAD_ReportProjectALl3(String projectId){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.cra_activity_report_project_all3, container, false);
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRA_REPORTPROJECTALL3+"?projectId="+projectId+"&token="+token); 
