...
public class CRALEAD_ReportProjectMenuHospital2 extends Fragment {
	String projectId;
	String hosptialId;
	public CRALEAD_ReportProjectMenuHospital2(String projectId,String hosptialId){
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRA_REPORTPROJECTMENUHOSPITAL2+"?projectId="+projectId+"&hosptialId="+hosptialId+"&token="+token);
