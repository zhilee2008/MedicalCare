...
public class CRALEAD_HistoryComplete extends Fragment {
...
//    String userType;
	...
	public CRALEAD_HistoryComplete(String checkupId) {
		// TODO Auto-generated constructor stub
		this.checkupId=checkupId;
	}
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		pd = ProgressDialog.show(CRALEAD_HistoryComplete.this.getActivity(), "提示", "加载中，请稍后……"); 
...
//    				crc_ordercomment
      	  ...
      	  CRALEAD_HistoryComplete.this.myHandler.sendMessage(msg);
        }
    }
