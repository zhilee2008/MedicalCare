...
public class CRALEAD_ReportProjectALl1 extends Fragment {
	String projectId;
	public CRALEAD_ReportProjectALl1(String projectId){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.cra_activity_report_project_all1, container, false);
...
//        webView.loadUrl("http://www.baidu.com"); 
        //http://localhost:8080/track/report/patientStateStatistic.jsp?projectId=11
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRA_REPORTPROJECTALL1+"?projectId="+projectId+"&token="+token); 
