...
public class CRALEAD_ReportCRAMenuCRA1 extends Fragment {
	String crcId;
	public CRALEAD_ReportCRAMenuCRA1(String crcId){
		this.crcId=crcId;
	}
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT+Constants.CRALEAD_REPORTCRAMENUCRA1+"?craId="+crcId+"&token="+token);
