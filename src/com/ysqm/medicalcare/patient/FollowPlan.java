...
//			            map.put("image", R.drawable.patientgreen);
			            ...
			            map.put("info", OrderingObj.getJSONObject("checkupDefine").get("name").toString()+"_"+OrderingObj.getJSONObject("project").get("name").toString()+ ("null".equals(OrderingObj.get("checkupPlanDate").toString()) ? "":"_"+OrderingObj.get("checkupPlanDate").toString()));  
