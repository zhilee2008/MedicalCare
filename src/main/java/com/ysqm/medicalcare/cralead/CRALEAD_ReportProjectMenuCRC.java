...
public class CRALEAD_ReportProjectMenuCRC extends Fragment {
    String projectId;
    String crcId;

    public CRALEAD_ReportProjectMenuCRC(String projectId, String crcId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRALEAD_ReportProjectMenuCRC1(projectId, crcId));
            }
        });
        ...
        cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRALEAD_ReportProjectMenuCRC2(projectId, crcId));
            }
        });
