...
public class CRALEAD_ReportProjectMenu extends Fragment {
    String projectId;

    public CRALEAD_ReportProjectMenu(String projectId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRALEAD_ReportProjectMenuAll(projectId));
            }
        });
        ...
        cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRALEAD_ReportProjectHospitalList(projectId));
            }
        });
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRALEAD_ReportProjectCRCList(projectId));
            }
        });
        return v;
    }
