...
public class CRALEAD_ReportProjectMenuCRC1 extends Fragment {
    String projectId;
    String crcId;

    public CRALEAD_ReportProjectMenuCRC1(String projectId, String crcId) {
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT + Constants.CRA_REPORTPROJECTMENUCRC1 + "?projectId=" + projectId + "&crcId=" + crcId + "&token=" + token);
