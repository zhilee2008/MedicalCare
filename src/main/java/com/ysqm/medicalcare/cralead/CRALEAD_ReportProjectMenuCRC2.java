...
public class CRALEAD_ReportProjectMenuCRC2 extends Fragment {
    String projectId;
    String crcId;

    public CRALEAD_ReportProjectMenuCRC2(String projectId, String crcId) {
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT + Constants.CRA_REPORTPROJECTMENUCRC2 + "?projectId=" + projectId + "&crcId=" + crcId + "&token=" + token);
