...
public class CRALEAD_PatientCurrentConfirm2Checked extends Fragment {
...
//    String userType;
    ...
    public CRALEAD_PatientCurrentConfirm2Checked(String checkupId, String patientId) {
...
//    				crc_ordercomment
            ...
            CRALEAD_PatientCurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
