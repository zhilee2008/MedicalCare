...
public class CRALEAD_CurrentOrderedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.cra_activity_current_ordered_list, container, false);
        ...
        pd = ProgressDialog.show(CRALEAD_CurrentOrderedList.this.getActivity(), "提示", "加载中，请稍后……");
    ...
    class MyAdspter extends BaseAdapter implements ListAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                //获得组件，实例化组件
                convertView = layoutInflater.inflate(R.layout.crc_activity_current_ordered_list_items, null);
            ...
            LinearLayout crcorderinglistitem = (LinearLayout) convertView.findViewById(R.id.crcorderinglistitem);
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity0.changeFragment(new CRALEAD_CurrentOrdered2Confirm(checkupId));
                }
            });
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread {
        public void run() {
            ...
            JSONObject obj = httpConnections.httpConnectionGet(Constants.CHECKUP + Constants.STATE + Constants.CRC_ORDERED_STATE, token);
            myAdspter = null;
            try {
...
//					bundle.putString("p_orderaddress", CurrentOrderObj.getJSONObject("hosptial").getString("name"));
...
//			            map.put("title", "");  
//			            map.put("info", "当前没有待确认的预约信息");
//			           map.put("checkupId","");
//			           list.add(map);
//      	    		myAdspter=new MyAdspter(getActivity(), list);
//      	    	}
