...
public class CRALEAD_ReportPatient extends Fragment {
    //	String patientId;
...
//	}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.cra_activity_report_patient, container, false);
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT + "patientStateStatistic.jsp?token=" + token);
