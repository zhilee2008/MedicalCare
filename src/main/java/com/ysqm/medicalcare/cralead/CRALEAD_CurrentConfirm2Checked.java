...
public class CRALEAD_CurrentConfirm2Checked extends Fragment {
...
//    String userType;
    ...
    public CRALEAD_CurrentConfirm2Checked(String checkupId) {
...
//    				crc_ordercomment
            ...
            CRALEAD_CurrentConfirm2Checked.this.myHandler.sendMessage(msg);
        }
    }
