...
public class CRALEAD_CurrentOrder extends Fragment {
...
//				Toast.makeText(getActivity(), b.getText(), 5);
                FragmentActivity0.changeFragment(new CRALEAD_CurrentOrderedList());
            }
        });
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity0.changeFragment(new CRALEAD_CurrentConfirmedList());
            }
        });
        ...
        cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity0.changeFragment(new CRALEAD_CurrentCheckedList());
            }
        });
        ...
        hv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity0.changeFragment(new CRALEAD_HistoryCompleteList());
            }
        });
