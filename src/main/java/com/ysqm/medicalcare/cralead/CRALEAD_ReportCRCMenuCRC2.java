...
public class CRALEAD_ReportCRCMenuCRC2 extends Fragment {
    String crcId;

    public CRALEAD_ReportCRCMenuCRC2(String crcId) {
        this.crcId = crcId;
    }
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT + Constants.CRA_REPORTCRCMENUCRC2 + "?crcId=" + crcId + "&token=" + token);
