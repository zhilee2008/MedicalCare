...
public class CRALEAD_PatientCurrentOrdered2Confirm extends Fragment {
...
//    String userType;
    ...
    public CRALEAD_PatientCurrentOrdered2Confirm(String checkupId, String patientId) {
...
//		userType = sp.getString("userType","");
        ...
        odth.start();
        view = inflater.inflate(R.layout.cra_activity_current_ordered_confirm, container, false);
    ...
    Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            LinearLayout llm = (LinearLayout) view.findViewById(R.id.crc_currentordercontainer);
...
//    				crc_ordercomment
            ...
            CRALEAD_PatientCurrentOrdered2Confirm.this.myHandler.sendMessage(msg);
        }
    }
