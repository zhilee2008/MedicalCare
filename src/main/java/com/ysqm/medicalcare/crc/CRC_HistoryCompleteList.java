...
import com.ysqm.medicalcare.crc.CRC_CurrentOrderedList.MyAdspter;
import com.ysqm.medicalcare.utils.Constants;
import com.ysqm.medicalcare.utils.HttpConnections;

public class CRC_HistoryCompleteList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.crc_activity_history_complete_list, container, false);
        ...
        pd = ProgressDialog.show(CRC_HistoryCompleteList.this.getActivity(), "提示", "加载中，请稍后……");
...
//						data.get(position).get("info");
                    ...
                    FragmentActivity0.changeFragment(new CRC_HistoryComplete(checkupId));
                }
            });
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread {
        public void run() {
            ...
            JSONObject obj = httpConnections.httpConnectionGet(Constants.CHECKUP + Constants.STATE + Constants.P_HISTORYORDER_STATE, token);
            myAdspter = null;
            try {
                List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
            ...
            CRC_HistoryCompleteList.this.myHandler.sendMessage(msg);
        }
    }
