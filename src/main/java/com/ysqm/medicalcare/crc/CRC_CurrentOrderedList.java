...
public class CRC_CurrentOrderedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.crc_activity_current_ordered_list, container, false);
        ...
        pd = ProgressDialog.show(CRC_CurrentOrderedList.this.getActivity(), "提示", "加载中，请稍后……");
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity0.changeFragment(new CRC_CurrentOrdered2Confirm(checkupId));
                }
            });
