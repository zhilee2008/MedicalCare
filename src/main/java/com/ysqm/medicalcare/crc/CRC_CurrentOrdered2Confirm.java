...
public class CRC_CurrentOrdered2Confirm extends Fragment {
...
//    String userType;
    ...
    public CRC_CurrentOrdered2Confirm(String checkupId) {
...
//		userType = sp.getString("userType","");
        ...
        view.findViewById(R.id.crcorderingconfirmbutton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                new AlertDialog.Builder(CRC_CurrentOrdered2Confirm.this.getActivity()).setTitle("提示")//设置对话框标题
                        .setMessage("确认患者预约?")//设置显示的内容
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {//添加确定按钮
                            @Override
                            public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                                // TODO Auto-generated method stub
                                Toast.makeText(CRC_CurrentOrdered2Confirm.this.getActivity(), "确认成功", 5).show();
...
//                         		mapParam.put("password", "passw0rd");
                                mapParam.put("checkupId", CRC_CurrentOrdered2Confirm.this.checkupId);
...
//    				crc_ordercomment
            ...
            CRC_CurrentOrdered2Confirm.this.myHandler.sendMessage(msg);
        }
    }
