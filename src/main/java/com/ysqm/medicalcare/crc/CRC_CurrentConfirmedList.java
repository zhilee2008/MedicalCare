...
public class CRC_CurrentConfirmedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.crc_activity_current_confirm_list, container, false);
        ...
        pd = ProgressDialog.show(CRC_CurrentConfirmedList.this.getActivity(), "提示", "加载中，请稍后……");
...
//						data.get(position).get("info");
                    ...
                    FragmentActivity0.changeFragment(new CRC_CurrentConfirm2Checked(checkupId));
                }
            });
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread {
        public void run() {
            ...
            CRC_CurrentConfirmedList.this.myHandler.sendMessage(msg);
        }
    }
