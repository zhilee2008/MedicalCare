...
public class DOC_AllPatientList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(DOC_AllPatientList.this.getActivity(), "提示", "加载中，请稍后……");
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity3.changeFragment(new DOC_PatientOrderList("3", patientId));
                }
            });
...
//			            map.put("image", R.drawable.patientgreen);
            ...
            DOC_AllPatientList.this.myHandler.sendMessage(msg);
        }
    }
