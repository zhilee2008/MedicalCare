...
public class DOC_PatientOrderList extends Fragment {
    ...
    public DOC_PatientOrderList(String tab, String patientId) {
                        ...
                        if ("1".equals(tab)) {
                            ...
                            if ("ordered".equals(currentCheckupState)) {
                                ...
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity1.changeFragment(new DOC_PatientCurrentOrdered2Confirm(currentCheckupId, patientId));
                                }
                            } else {
                            ...
                            if ("ordered".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity2.changeFragment(new DOC_PatientCurrentOrdered2Confirm(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                            ...
                            if ("ordered".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity3.changeFragment(new DOC_PatientCurrentOrdered2Confirm(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                    ...
                    if (objCO != null && objCO.getJSONArray("data").length() > 0) {
                        if ("1".equals(tab)) {
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity1.changeFragment(new DOC_PatientCurrentConfirm2Checked(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity2.changeFragment(new DOC_PatientCurrentConfirm2Checked(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity3.changeFragment(new DOC_PatientCurrentConfirm2Checked(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                    ...
                    if (objCH != null && objCH.getJSONArray("data").length() > 0) {
                        if ("1".equals(tab)) {
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity1.changeFragment(new DOC_PatientCurrentChecked2Complete(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                ...
                                if (!("".equals(currentCheckupId))) {
                                    ...
                                    FragmentActivity2.changeFragment(new DOC_PatientCurrentChecked2Complete(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
                            ...
                            if ("confirmed".equals(currentCheckupState)) {
                                //受试者
                                if (!("".equals(currentCheckupId))) {
                                    FragmentActivity3.changeFragment(new DOC_PatientCurrentChecked2Complete(currentCheckupId, patientId));
                                }
                            } else {
                                Toast.makeText(v.getContext(), "暂无预约信息", 5).show();
                            }
