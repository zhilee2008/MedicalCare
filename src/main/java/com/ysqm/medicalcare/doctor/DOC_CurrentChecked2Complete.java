...
public class DOC_CurrentChecked2Complete extends Fragment {
...
//    String userType;
    ...
    public DOC_CurrentChecked2Complete(String checkupId) {
...
//    				crc_ordercomment
            ...
            DOC_CurrentChecked2Complete.this.myHandler.sendMessage(msg);
        }
    }
