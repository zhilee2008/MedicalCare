...
public class DOC_CurrentConfirmedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(DOC_CurrentConfirmedList.this.getActivity(), "提示", "加载中，请稍后……");
...
//						data.get(position).get("info");
                    ...
                    FragmentActivity0.changeFragment(new DOC_CurrentConfirm2Checked(checkupId));
                }
            });
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread {
        public void run() {
            ...
            DOC_CurrentConfirmedList.this.myHandler.sendMessage(msg);
        }
    }
