...
public class CurrentOrder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.activity_current_order, container, false);
        ...
        pd = ProgressDialog.show(CurrentOrder.this.getActivity(), "提示", "加载中，请稍后……");
        oth = new OrderThread();
        oth.start();
        return view;
    }
...
//	        					lla.setGravity(Gravity.RIGHT);
    ...
    class OrderThread extends Thread {
        public void run() {
            ...
            JSONObject obj = httpConnections.httpConnectionGet(Constants.P_CURRENTORDER + Constants.P_CURRENTCONFIRM_STATE, token);
            ...
            CurrentOrder.this.myHandler.sendMessage(msg);
        }
    }
