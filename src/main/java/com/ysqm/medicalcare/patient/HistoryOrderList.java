...
public class HistoryOrderList extends Fragment {
    ...
    public HistoryOrderList(String projectId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_historyorder_list, container, false);
        pd = ProgressDialog.show(HistoryOrderList.this.getActivity(), "提示", "加载中，请稍后……");
    ...
    class MyAdspter extends BaseAdapter implements ListAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                //获得组件，实例化组件
                convertView = layoutInflater.inflate(R.layout.activity_historyorder_list_items, null);
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity0.changeFragment(new HistoryOrderDetail(checkupId));
                }
            });
    ...
    class FollowPlanThread extends Thread {
        public void run() {
            ...
            JSONObject obj = httpConnections.httpConnectionGet(Constants.P_CURRENTORDER + Constants.P_HISTORYORDER_STATE, token);
...
//			            map.put("image", R.drawable.patientgreen);
            ...
            HistoryOrderList.this.myHandler.sendMessage(msg);
        }
    }
