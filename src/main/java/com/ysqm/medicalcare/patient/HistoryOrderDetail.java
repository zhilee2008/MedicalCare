...
public class HistoryOrderDetail extends Fragment {
    ...
    public HistoryOrderDetail(String checkupId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.activity_historyorder_detail, container, false);
        ...
        pd = ProgressDialog.show(HistoryOrderDetail.this.getActivity(), "提示", "加载中，请稍后……");
        oth = new OrderThread();
        oth.start();
        return view;
    }
...
//	        					lla.setGravity(Gravity.RIGHT);
    ...
    class OrderThread extends Thread {
        public void run() {
            ...
            HistoryOrderDetail.this.myHandler.sendMessage(msg);
        }
    }
