...
public class MessageList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(MessageList.this.getActivity(), "提示", "加载中，请稍后……");
    ...
    class MyAdspter extends BaseAdapter implements ListAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                //获得组件，实例化组件
                convertView = layoutInflater.inflate(R.layout.activity_message_list_items, null);
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity2.changeFragment(new MessageDetail(checkupId));
                }
            });
...
//			            map.put("image", R.drawable.patientgreen);
                        map.put("title", OrderingObj.get("name").toString());
            ...
            MessageList.this.myHandler.sendMessage(msg);
        }
    }
