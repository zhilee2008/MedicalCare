...
public class CRA_AllPatientList extends Fragment {
    //test forgit
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(CRA_AllPatientList.this.getActivity(), "提示", "加载中，请稍后……");
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity2.changeFragment(new CRA_PatientOrderList("2", patientId));
                }
            });
...
//			            map.put("image", R.drawable.patientgreen);
            ...
            CRA_AllPatientList.this.myHandler.sendMessage(msg);
        }
    }
