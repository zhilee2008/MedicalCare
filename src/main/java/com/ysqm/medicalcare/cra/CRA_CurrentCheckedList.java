...
public class CRA_CurrentCheckedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(CRA_CurrentCheckedList.this.getActivity(), "提示", "加载中，请稍后……");
...
//						data.get(position).get("info");
                    ...
                    FragmentActivity0.changeFragment(new CRA_CurrentChecked2Complete(checkupId));
                }
            });
...
//			LoginActivity.this.finish();
    ...
    class OrderedThread extends Thread {
        public void run() {
            ...
            CRA_CurrentCheckedList.this.myHandler.sendMessage(msg);
        }
    }
