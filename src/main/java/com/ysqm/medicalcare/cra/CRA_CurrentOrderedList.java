...
public class CRA_CurrentOrderedList extends Fragment {
    OrderedThread odth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pd = ProgressDialog.show(CRA_CurrentOrderedList.this.getActivity(), "提示", "加载中，请稍后……");
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            crcorderinglistitem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FragmentActivity0.changeFragment(new CRA_CurrentOrdered2Confirm(checkupId));
                }
            });
