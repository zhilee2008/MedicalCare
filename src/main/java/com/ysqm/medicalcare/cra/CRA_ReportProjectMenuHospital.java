...
public class CRA_ReportProjectMenuHospital extends Fragment {
    String projectId;
    String hospitalId;

    public CRA_ReportProjectMenuHospital(String projectId, String hospitalId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRA_ReportProjectMenuHospital1(projectId, hospitalId));
            }
        });
        ...
        cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRA_ReportProjectMenuHospital2(projectId, hospitalId));
            }
        });
