...
public class CRA_CurrentChecked2Complete extends Fragment {
...
//    String userType;
    ...
    public CRA_CurrentChecked2Complete(String checkupId) {
...
//    				crc_ordercomment
            ...
            CRA_CurrentChecked2Complete.this.myHandler.sendMessage(msg);
        }
    }
