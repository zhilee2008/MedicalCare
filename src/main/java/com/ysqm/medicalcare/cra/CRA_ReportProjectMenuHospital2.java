...
public class CRA_ReportProjectMenuHospital2 extends Fragment {
    String projectId;
    String hospitalId;

    public CRA_ReportProjectMenuHospital2(String projectId, String hospitalId) {
...
//        webView.loadUrl("http://www.baidu.com"); 
        webView.loadUrl(Constants.WSDL_URL_REPORT + Constants.CRA_REPORTPROJECTMENUHOSPITAL2 + "?projectId=" + projectId + "&hospitalId=" + hospitalId + "&token=" + token);
