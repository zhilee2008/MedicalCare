...
public class CRA_ReportCRCMenuCRC extends Fragment {
    String projectId;

    public CRA_ReportCRCMenuCRC(String projectId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRA_ReportCRCMenuCRC1(projectId));
            }
        });
        ...
        cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentActivity3.changeFragment(new CRA_ReportCRCMenuCRC2(projectId));
            }
        });
